      module NumericalSimulatorMINC_Routines
...
cc        
     ...
     3           P0,T0,COMPF,COMTF,AAAF,COMPM,COMTM,AAAM,PRAT)
      ...
      DIMENSION P(MR,NZ),T(MR,NZ),SV(MR,NZ),X(MR,NZ)
      DIMENSION P0(MR,NZ),T0(MR,NZ)
      DIMENSION AR(MR),V(MR,NZ),DELR(MR)
      DIMENSION AZ(MR,NZ-1),DELZ(NZ-1)
      DIMENSION C1(2*MR),C2(2*MR),C3(2*MR),C4(2*MR)
      DIMENSION C5(2*MR),C6(2*MR),C7(2*MR)
      DIMENSION XX(2*MR,NZ),R(2*MR),RR(2*MR)
      DIMENSION IPH(MR,NZ)
      DIMENSION PORFR(MR),PERFR(MR),PRAT(MR)
      DIMENSION PORMA(MR),PERMA(MR)
      DIMENSION BMOLD(MR,NZ),BEOLD(MR,NZ)
      DIMENSION ALM1(MR,NZ),ALM2(MR,NZ),ALE1(MR,NZ)
      DIMENSION ALE2(MR,NZ),ROM(MR,NZ),ROE(MR,NZ)
	DIMENSION XXX(2*MR)
...
cc----7--1--------2---------3---------4---------5---------6---------7---------8 
      ...
      end module NumericalSimulatorMINC_Routines