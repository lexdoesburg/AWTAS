...
def get_expected_output(test_file):
    with open(test_file, 'r') as file:
        ...
        file.next() # Skip more metadata
        variables_string = file.readline()
        variables = [float(value) for value in parameters_string.split(',')]
...
@pytest.mark.parametrize('test_file', ['theis_testcase1.txt', 'theis_testcase2.txt'])
