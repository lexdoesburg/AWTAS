...
class PlotWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.data = data_class.Theis_Data()
        self.model = None
    ...
    def plot_data(self):
        ...
        if filename:
            ...
            if self.data:
                ...
                self.data = data_class.Theis_Data(filename=filename)
            end = time.time()
    ...
    def create_parameters_groupbox(self):
        ...
        parameters_groupbox.setAlignment(4) # Puts groupbox label in the center
        ...
        variables_groupbox.setAlignment(4) # Puts groupbox label in the center

        variables_grid = QGridLayout()
        for i, (variable, info) in enumerate(self.data.variables.items()):
            variables_grid.addWidget(QLabel('{} [{}]: '.format(variable, info['Units'])), i, 0)
            new_label = QLabel()
